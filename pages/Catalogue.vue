            ...
            <template #list="slotProps">
                <div class="col-12">
                    <div class="flex flex-column xl:flex-row xl:align-items-start p-3 gap-4">
                       ...
                       <img class="w-40 h-40 sm:w-16rem sm:h-16rem xl:w-10rem xl:h-10rem  object-contain shadow-2 block xl:block mx-auto border-round" :src="`${directusBase}/assets/${slotProps.data.photo}?fit=cover&width=300&height=300&quality=40`" :alt="slotProps.data.name" />
                        </NuxtLink>
                ...
                <div class="col-12 sm:col-6 lg:col-4 xl:col-3 p-2">
                    <div class="p-4 border-1 surface-border surface-card border-round">
                        ...
                        <div class="flex flex-column align-items-center gap-3 py-5">
                            <NuxtLink :to="`/outil-${slotProps.data.id}`">
                            <img class="w-80 h-60 object-contain border-round" :src="`${directusBase}/assets/${slotProps.data.photo}?height=300&quality=40`" :alt="slotProps.data.name" />
                            </NuxtLink>
