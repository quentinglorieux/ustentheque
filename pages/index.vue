    ...
    <div class="surface-section px-4 py-6 md:px-6 lg:px-8 mb-4 card">
      <div class="text-700 text-center">
        ...
        <div v-if="isAuthenticated">
          <div class="text-900 font-bold text-4xl mb-1">Bienvenue {{ user.first_name }}</div>
        ...
        <div v-if="!isAuthenticated" class="md:flex justify-center gap-10">
          <NuxtLink to="/auth/signup">
            <Button label="Devenez membre de la BibOB" icon="pi pi-plus-circle" severity="info"
              class="font-bold mb-3 px-5 py-3 p-button-raised m-10 white-space-nowrap"></Button>
          </NuxtLink>
          <NuxtLink class="" to="/auth/login">
            <Button label="Connexion" icon="pi pi-sign-in" severity="info"
              class="font-bold px-5 py-3 p-button-raised white-space-nowrap"></Button>
          </NuxtLink>
        </div>
      </div>
    </div>
    ...
    <div v-if="isAuthenticated">
      ...
      <div class="grid">
        ...
        <div class="col-12 lg:col-6 xl:col-3">
          <StatCard title="Emprunts" :value="userBorrowed" icon="pi-download" color="blue" />
        </div>

        <div class="col-12 lg:col-6 xl:col-3">
          <StatCard title="Prêts" :value="userLent" icon="pi-upload" color="orange" />
        </div>

        <div class="col-12 lg:col-6 xl:col-3">
          <StatCard title="Objets dans la BibOB" :value="totalItems" icon="pi-box" color="cyan" />
        </div>
